  ...
  return (
    ...
    >
      <div className="nav_menu flex flex-col justify-center items-center px-4 py-1 cursor-pointer">
        ...
        <p style={{ color: "hsla(236, 9%, 39%, 0.8)", fontSize: "12px" }}>Home</p>
      </div>
      <div className="nav_menu flex flex-col justify-center items-center px-4 py-1 cursor-pointer">
        <AppsSharpIcon color="action" fontSize="small"></AppsSharpIcon>
        <p style={{ color: "hsla(236, 9%, 39%, 0.8)", fontSize: "12px" }}>Markets</p>
      </div>
      <div className="nav_menu flex flex-col justify-center items-center px-4 py-1 cursor-pointer">
        <ShowChartOutlinedIcon color="action" fontSize="small"></ShowChartOutlinedIcon>
        <p style={{color: "hsla(236, 9%, 39%, 0.8)", fontSize: "12px" }}>Activity</p>
      </div>
      <div className="nav_menu flex flex-col justify-center items-center px-4 py-1 cursor-pointer">
        <LeaderboardIcon color="action" fontSize="small"></LeaderboardIcon>
        <p style={{color: "hsla(236, 9%, 39%, 0.8)", fontSize: "12px" }}>Leaderboard</p>
      </div>
      <div className="nav_menu flex flex-col justify-center items-center px-4 py-1 cursor-pointer">
        <MenuOutlinedIcon color="action" fontSize="small"></MenuOutlinedIcon>
        <p style={{color: "hsla(236, 9%, 39%, 0.8)", fontSize: "12px" }}>Menu</p>
      </div>
    </div>
  );
};
